                    ...
                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                      ...
                      <div class="w-100 mt-auto">
                        ...
                        <a href="#" class="badge bg-danger mb-2">
                          <i class="fas fa-circle me-2 small fw-bold"></i>Travel
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-12">
                  ...
                  <div class="card mb-3">
                    <div class="row g-3">
                      <div class="col-4">
                        <img class="rounded" src="/images/news1.jpg" alt="" />
                      </div>
                      <div class="col-8">
                        <h6>
                          <a
                  ...
                  <div class="card mb-3">
                    <div class="row g-3">
                      <div class="col-4">
                        <img class="rounded" src="/images/news4.jpg" alt="" />
                      </div>
                      <div class="col-8">
                        <h6>
                          <a
                  ...
                  <div class="card mb-3">
                    <div class="row g-3">
                      <div class="col-4">
                        <img class="rounded" src="/images/news5.jpg" alt="" />
                      </div>
                      <div class="col-8">
                        <h6>
                          <a
